...
- `reviewer` — Constructive code reviewer with auto-fix, report, and PR comment modes. Orthogonal `--with <skill1>,<skill2>` flag loads up to 3 additional review lenses from `skills/<name>/lens.md` (each capped at 80 lines / 600 tokens) and applies them as extra rubric criteria — see the [Review-Lens Contract](./skills/create-skill/rules/review-lens-contract.md) and the [`lens.md` template](./skills/create-skill/templates/lens.md). Opt-in lenses currently available: [`ai-engineering`](./skills/ai-engineering/lens.md), [`animations`](./skills/animations/lens.md), [`charting`](./skills/charting/lens.md), [`dx`](./skills/dx/lens.md), [`holistic-analysis`](./skills/holistic-analysis/lens.md), [`otel-instrumentation`](../../../agent-skills.git/main/skills/otel-instrumentation/lens.md) (sibling repo), [`ux`](./skills/ux/lens.md) (canonical interface; reviewer auto-loads `ux` on UI diffs so `--with ux` dedupes to a no-op)
