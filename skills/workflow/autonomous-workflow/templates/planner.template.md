...
| ----- | ------------------- | ------------------------------------------------ | ----------------- |
| 1     | `persistent-memory` | Always — load prior workflow lessons before design | `read aw-lessons` |
...
Before research, run `Skill("persistent-memory", "read aw-lessons")` and treat
