...
1. Run [`test-provenance-guard`](../../test-provenance-guard/SKILL.md) on
...
| Layer       | Skill / tool                                            |
| ----------- | ------------------------------------------------------- |
| Unit        | [`tdd`](../../tdd/SKILL.md) — Vitest + RTL stack.      |
| Component   | [`tdd`](../../tdd/SKILL.md) — Vitest + RTL or Playwright component test. |
