...
- Modified `src/main/java/com/acme/orders/OrderService.java`: [what and why]
- Added `src/test/java/com/acme/orders/OrderServiceTest.java`: [purpose]
