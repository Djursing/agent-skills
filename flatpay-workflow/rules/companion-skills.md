...
| `ux`                 | 3     | Files touched include `*.tsx`, `*.jsx`, `*.vue`, `*.svelte`, RN screens (usually not triggered in backend-only Spring repos) | — | Remove invocation in [`phase-3-implementation.md`](./phase-3-implementation.md#ux-trigger)  |
