...
| Stuck-loop cap hit on same failing area (3 Lite / 5 Full) | Run `confidence(bug-analysis)`, auto-replan or escalate |
...
6. Stuck-loop cap hit (3 iterations in Lite, 5 in Full).
